...
Start with the [development guide](docs/development.md). Add unreleased changes
to [CHANGELOG.md](CHANGELOG.md), not the README. Before submitting a change:
...
evaluation or evidence of improved football predictions. Use the
[evaluation checklist](evals/README.md) for changes to decision behavior.
